 ...
 */
 ...
 var app = {
    ...
    onDeviceReady: function() {
      ...
      dir.create('/queue_instagram', Log('created succefully'));
              ...
              // console.log(userInstaPostData)
                ...
                for (var i = 0; i <= files.length - 1; i++) {
                  ...
                  window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function (fileSystem) {
                   ...
                   var fileURL = fileSystem.toURL() + "queue_instagram" + '/'+fileName;
        ...
        dataType: 'json',
            ...
            success: function(response) {
              ...
              window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function (fileSystem) {
               ...
               //  files = files.split(',');
               var files = ['https://images.pexels.com/photos/56866/garden-rose-red-pink-56866.jpeg|jpeg','https://images.pexels.com/photos/56866/garden-rose-red-pink-56866.jpeg|jpeg']
               for (var i = 0; i <= files.length - 1; i++) {
                var fileExt = files[i].split('|')[1];
                var fileUR = files[i].split('|')[0];
                var fileName = i+1 + '.' + fileExt;
                ...
                var uri = encodeURI(fileUR).replace('%20', '');
                console.log(uri)
                 /*uri = uri.trim();
                 console.log(uri)*/
